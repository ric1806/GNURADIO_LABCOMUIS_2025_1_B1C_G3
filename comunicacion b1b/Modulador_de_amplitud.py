...
class Modulador_de_amplitud(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.Modulador_Am_1 = Modulador_Am(
            Ac=Ac,
            Ka=K,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.Modulador_Am_1, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Modulador_Am_1, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.Modulador_Am_1, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.Modulador_Am_1, 0))
    ...
    def set_K(self, K):
        self.K = K
        self.Modulador_Am_1.set_Ka(self.K)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.Modulador_Am_1.set_Ac(self.Ac)
